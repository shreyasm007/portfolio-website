    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900 dark:text-white">Professional Journey</h2>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300 mb-8">
            <li className="text-gray-600 dark:text-gray-300">Large Language Model Integration</li>
            <li className="text-gray-600 dark:text-gray-300">Retrieval Augmented Generation (RAG)</li>
            <li className="text-gray-600 dark:text-gray-300">Prompt Engineering</li>
            <li className="text-gray-600 dark:text-gray-300">AI Application Architecture</li>
          </ul>
        </div>
      </motion.div>
    </div>
